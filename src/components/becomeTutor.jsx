...
<div className='max-w-[800px] w-full h-[110vh] mx-auto text-center flex flex-col mt-[95px]' >
        ...
        <form className='flex flex-col justify-center items-center gap-6' onSubmit={handleSubmit}>
            ...
            <select  className="shadow appearance-none border rounded py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" value={module} onChange={getSelectedValue} required>
