  ...
  return (
    <div className='mt-[95px] mb-[85px]'>
        ...
        <form className='flex flex-col justify-center items-center gap-6' onSubmit={handleSubmit}>
            ...
            <select  className=" w-[350px] shadow appearance-none border rounded py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" value={module} onChange={(e) => getSelectedValue(e)} required>
